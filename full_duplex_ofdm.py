...
class full_duplex_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, udp_tx_ip="127.0.0.1", udp_tx_port=9000):
        ...
        self.settings = Qt.QSettings("GNU Radio", "full_duplex_ofdm")
        ...
        self.freq_2 = freq_2 = 500000000
        self.freq_1 = freq_1 = 440000000
        self.bw = bw = 1500000
        ...
        self.tab_layout_0.addWidget(self._samp_rate_win)
        ...
        self.tab_layout_0.addWidget(self._freq_offset_win)
        self._freq_2_range = Range(300000000, 2500000000, 10000000, 500000000, 200)
        self._freq_2_win = RangeWidget(self._freq_2_range, self.set_freq_2, "freq_2", "counter_slider", float)
        self.tab_layout_0.addWidget(self._freq_2_win)
        self._freq_1_range = Range(300000000, 2500000000, 10000000, 440000000, 200)
        self._freq_1_win = RangeWidget(self._freq_1_range, self.set_freq_1, "freq_1", "counter_slider", float)
        self.tab_layout_0.addWidget(self._freq_1_win)
        ...
        self.tab_layout_0.addWidget(self._bw_win)
        ...
        self.tab_layout_1.addWidget(self._atten_win)
        ...
        self.digital_ofdm_rx_0_1_0 = digital.ofdm_rx(
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_b(range(255), True, 1, ())
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.pluto_sink_0_0_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.osmosdr_sink_0_0_0, 0))    
        ...
        self.connect((self.digital_ofdm_rx_0_1, 0), (self.blocks_uchar_to_float_0_0, 0))    
        self.connect((self.digital_ofdm_rx_0_1_0, 0), (self.blocks_uchar_to_float_0_0_0, 0))    
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_multiply_const_vxx_0, 0))    
        self.connect((self.digital_ofdm_tx_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))    
        self.connect((self.osmosdr_source_0, 0), (self.digital_ofdm_rx_0_1, 0))    
        self.connect((self.pluto_source_0_0, 0), (self.digital_ofdm_rx_0_1_0, 0))    
    ...
    def set_rf_gain(self, rf_gain):
        ...
        self.osmosdr_sink_0_0_0.set_gain(self.rf_gain, 0)
    ...
    def set_if_gain(self, if_gain):
        ...
        self.osmosdr_sink_0_0_0.set_if_gain(self.if_gain, 0)
    ...
    def set_bb_gain(self, bb_gain):
        ...
        self.osmosdr_sink_0_0_0.set_bb_gain(self.bb_gain, 0)
...
def main(top_block_cls=full_duplex_ofdm, options=None):
    if options is None:
    ...
    tb = top_block_cls(udp_tx_ip=options.udp_tx_ip, udp_tx_port=options.udp_tx_port)
    tb.start()
    tb.show()
