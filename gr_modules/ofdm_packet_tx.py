...
# Title: Ofdm Packet Tx
# Generated: Mon Apr 23 12:09:27 2018
##################################################
...
class ofdm_packet_tx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ofdm Packet Tx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ofdm Packet Tx")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_packet_tx")
        ...
        self._freq_range = Range(400000000, 3800000000, 10000000, 440000000, 200)
        ...
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_char*1, '', 'packet_len'); self.blocks_tag_debug_0.set_display(True)
        self.blocks_pdu_to_tagged_stream_0 = blocks.pdu_to_tagged_stream(blocks.byte_t, 'packet_len')
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((0.02, ))
...
def main(top_block_cls=ofdm_packet_tx, options=None):
