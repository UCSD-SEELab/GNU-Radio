...
# Generated: Mon Oct 16 17:50:41 2017
##################################################
...
class constellation_rx(gr.top_block):

    def __init__(self, center_freq=440000000):
        gr.top_block.__init__(self, "Constellation Rx")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:/Projects/gr-bladerf-utils/_out.bin', False)
        ...
        self.connect((self.digital_constellation_receiver_cb_0, 0), (self.blocks_repack_bits_bb_0, 0))
...
def main(top_block_cls=constellation_rx, options=None):
    if options is None:
